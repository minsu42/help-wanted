...
> **Day**: 3 (오전, **반드시 오전에**) | **Status**: Incomplete | **Layer**: Polish
> **Type**: Integration
> **Estimate**: 0.5h
...
>
> ⚠ **이 스토리는 닫히지 않았다.** `production/qa/smoke-2026-08-09.md`가 스스로
> *"story-019의 최종 사인오프가 아니다"* 라고 적어 두었다.
>
> **⚠ 경진대회 제출은 아직 남아 있고 마감이 이번 주다 (2026-08-09 확인).**
> 다만 **제출 전용 단계를 두지 않기로 했다** — 계속 구현하다가 마감 시점의 빌드를
> 그대로 제출한다. 그래서 이 스토리의 배포·스모크 절차는 **폐기가 아니라 상시
> 가동 대상**이다: `main`이 항상 배포 가능해야 한다는 규칙의 실행 수단이 이것이다.
> 근거: `production/roadmap.md`의 「경진대회 제출에 대하여」 절.
>
> **폐기된 것**: 수락 기준의 *"배포본에서 15일 완주"* — 15일 고정 회차가 폐기됐다.
> Day 3 오전이라는 시점 지정도 무의미해졌다.
>
> **살아 있는 것**: 배포 파이프라인, `base: "./"` 상대경로 검증, 스모크 절차,
> 심사 계정 초대, 제출물(동영상 + PDF 2종). 이들은 마감 전에 반드시 다시 돈다.
>
> **대체·확장**: `production/roadmap.md` **P8**.
